// https://github.com/tokens-studio/figma-plugin/blob/main/src/utils/color/lighten.ts
...
const theme = {
  lighten(color, colorSpace, amount) {
    ...
    switch (colorSpace) {
      ...
      default: {
        return color.lighten(amount).toString({ format: 'hex' })
      }
    }
  },
}

export const { lighten } = theme
